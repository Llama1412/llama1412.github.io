! function (factory, window) {
    "use strict";
    "function" == typeof define && define.amd ? define(["leaflet"], factory) : "object" == typeof exports && (module.exports = factory(require("leaflet"))), void 0 !== window && window.L && (window.L.Ruler = factory(L))
}(function (L) {
    "use strict";
    L.Control.Ruler = L.Control.extend({
        ...
        _escape: function (e) {
            27 === e.keyCode && (this._clickCount > 0 ? this._closePath() : (this._choice = !0, this._toggleMeasure()))
        },
        _calculateBearingAndDistance: function () {
            var f1 = this._clickedLatLong.lat,
                ...
                y = Math.sin((l2 - l1) * toRadian) * Math.cos(f2 * toRadian),
                x = Math.cos(f1 * toRadian) * Math.sin(f2 * toRadian) - Math.sin(f1 * toRadian) * Math.cos(f2 * toRadian) * Math.cos((l2 - l1) * toRadian),
                brng = Math.atan2(y, x) * ((this.options.angleUnit.factor ? this.options.angleUnit.factor / 2 : 180) / Math.PI);
            ...
            var R = this.options.lengthUnit.factor ? 6371 * this.options.lengthUnit.factor : 6371,
                deltaF = (f2 - f1) * toRadian,
                deltaL = (l2 - l1) * toRadian,
                a = Math.sin(deltaF / 2) * Math.sin(deltaF / 2) + Math.cos(f1 * toRadian) * Math.cos(f2 * toRadian) * Math.sin(deltaL / 2) * Math.sin(deltaL / 2),
        ...
        _closePath: function () {
            this._map.removeLayer(this._tempLine), this._map.removeLayer(this._tempPoint), this._choice = !1, L.DomEvent.on(this._container, "click", this._toggleMeasure, this), this._toggleMeasure()
        }
